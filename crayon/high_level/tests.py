...
#        machine = Machine.objects.create(nom="scie",
#                               prix=1000,
#                               n_serie="16832")
...
#        ressource1 = Ressource.objects.create(nom = "bois",
#                                              prix = 1)
#        qu_ressource = Quantite_Ressource.objects.create(ressource=ressource1,
#                                           quantite=1000)
